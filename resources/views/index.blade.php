...
&lt;/ul&gt;'>
            ...
            <ul class="list-inline">
              <li>
                <a href="https://www.boost-project.com/de/shops?charity_id=1129&amp;tag=bl" target="_blank" id="foerdershops" class="btn btn-default">{{ trans('index.conveyor') }}
                </a>
              </li>
              ...
              <li id="plug" @unless ($browser === 'Firefox' || $browser === 'Mozilla' || $browser === 'Chrome' || $browser === 'Opera' || $browser === 'IE' || $browser === 'Edge')
                ...
                <a href="#" id="plugin" data-toggle="modal" data-target="#plugin-modal" class="btn btn-default">{{ trans('index.plugin') }}</a>
              </li>
            </ul>
          </figure>
