...
<ol><li><p>{{ trans('hilfe.faq.2') }}</p>
  ...
  <ul><li>{{ trans('hilfe.faq.10') }}</li>
    <li>{{ trans('hilfe.faq.11') }} <a href="http://www.klug-suchen.de/" target="_blank">klug-suchen.de.</a></li></ul>
  <li><p>{{ trans('hilfe.faq.12') }}</p>
    <p>{{ trans('hilfe.faq.13') }}</p></li>
  <li>{{ trans('hilfe.faq.14') }}</li>
  <p>{{ trans('hilfe.faq.15') }}</p>
  <ul><li>{{ trans('hilfe.faq.16') }}</li>
    <li>{{ trans('hilfe.faq.17') }}</li></ul>
  ...
  <ul><li>{{ trans('hilfe.faq.27') }}</li>
    <li>{{ trans('hilfe.faq.28') }}</li>
    <li>{{ trans('hilfe.faq.29') }}</li></ul>
  ...
  <li><p>{{ trans('hilfe.faq.48') }}</p>
    ...
    <ul><li><p>{{ trans('hilfe.faq.51') }}</p></li>
      ...
      <li><p>{{ trans('hilfe.faq.56') }}</p></li></ul></li>
